...
public class NeoForgeFluidHelper implements IFluidHelper {
    ...
    @Override
    public Identifier stillTexture(Fluid fluid) {
        return fluidModel(fluid).stillMaterial().sprite().contents().name();
    }

    @Override
    public int tint(Fluid fluid) {
        net.minecraft.client.renderer.block.FluidModel model = fluidModel(fluid);
    ...
    private static net.minecraft.client.renderer.block.FluidModel fluidModel(Fluid fluid) {
