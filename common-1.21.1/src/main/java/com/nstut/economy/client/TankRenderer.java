...
public class TankRenderer implements BlockEntityRenderer<TankBlockEntity> {
    ...
    public void render(@NotNull TankBlockEntity tank, float partialTick, @NotNull PoseStack poseStack,
        ...
        int light = 0xF000F0;
        int color = com.nstut.economy.platform.Services.FLUID.tint(stack.getFluid());
    ...
    private static TextureAtlasSprite getFluidSprite(Fluid fluid) {
        ResourceLocation stillTexture = Services.FLUID.stillTexture(fluid);
    ...
    private static void drawQuad(VertexConsumer vc, Matrix4f m, float x0, float y0, float z, float x1, float y1, float z2, float u0, float u1, float v0, float v1, int light, int color) {
        ...
        if (a == 0) a = 1f;
        vc.addVertex(m, x0, y1, z).setColor(r, g, b, a).setUv(u0, v1).setLight(light).setNormal(0, 0, -1);
        vc.addVertex(m, x1, y1, z).setColor(r, g, b, a).setUv(u1, v1).setLight(light).setNormal(0, 0, -1);
        vc.addVertex(m, x1, y0, z).setColor(r, g, b, a).setUv(u1, v0).setLight(light).setNormal(0, 0, -1);
        vc.addVertex(m, x0, y0, z).setColor(r, g, b, a).setUv(u0, v0).setLight(light).setNormal(0, 0, -1);
    }
    ...
    private static void drawQuadZ(VertexConsumer vc, Matrix4f m, float x, float y0, float z0, float x2, float y1, float z1, float u0, float u1, float v0, float v1, int light, int color) {
        ...
        float a = ((color >> 24) & 0xFF) / 255f;
        if (a == 0) a = 1f;
        vc.addVertex(m, x, y1, z1).setColor(r, g, b, a).setUv(u1, v1).setLight(light).setNormal(-1, 0, 0);
        vc.addVertex(m, x, y1, z0).setColor(r, g, b, a).setUv(u0, v1).setLight(light).setNormal(-1, 0, 0);
        vc.addVertex(m, x, y0, z0).setColor(r, g, b, a).setUv(u0, v0).setLight(light).setNormal(-1, 0, 0);
        vc.addVertex(m, x, y0, z1).setColor(r, g, b, a).setUv(u1, v0).setLight(light).setNormal(-1, 0, 0);
    }
    ...
    private static void drawQuadTop(VertexConsumer vc, Matrix4f m, float x0, float y, float z0, float x1, float y2, float z1, float u0, float u1, float v0, float v1, int light, int color) {
        ...
        float a = ((color >> 24) & 0xFF) / 255f;
        if (a == 0) a = 1f;
        vc.addVertex(m, x1, y, z0).setColor(r, g, b, a).setUv(u1, v1).setLight(light).setNormal(0, 1, 0);
        vc.addVertex(m, x0, y, z0).setColor(r, g, b, a).setUv(u0, v1).setLight(light).setNormal(0, 1, 0);
        vc.addVertex(m, x0, y, z1).setColor(r, g, b, a).setUv(u0, v0).setLight(light).setNormal(0, 1, 0);
        vc.addVertex(m, x1, y, z1).setColor(r, g, b, a).setUv(u1, v0).setLight(light).setNormal(0, 1, 0);
    }
    ...
    private static void drawQuadBottom(VertexConsumer vc, Matrix4f m, float x0, float y, float z0, float x1, float y2, float z1, float u0, float u1, float v0, float v1, int light, int color) {
        ...
        float a = ((color >> 24) & 0xFF) / 255f;
        if (a == 0) a = 1f;
        vc.addVertex(m, x1, y, z1).setColor(r, g, b, a).setUv(u1, v1).setLight(light).setNormal(0, -1, 0);
        vc.addVertex(m, x0, y, z1).setColor(r, g, b, a).setUv(u0, v1).setLight(light).setNormal(0, -1, 0);
        vc.addVertex(m, x0, y, z0).setColor(r, g, b, a).setUv(u0, v0).setLight(light).setNormal(0, -1, 0);
        vc.addVertex(m, x1, y, z0).setColor(r, g, b, a).setUv(u1, v0).setLight(light).setNormal(0, -1, 0);
    }
}
